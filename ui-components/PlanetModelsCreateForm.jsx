...
export default function PlanetModelsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPlanetType(initialValues.PlanetType);
    setDistanceFromSun(initialValues.DistanceFromSun);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PlanetModels(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PlanetModelsCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
